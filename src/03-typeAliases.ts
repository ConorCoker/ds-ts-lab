import {
  ...
  import { friends } from "./01-basics";
    ...
    function makeBuddyList(
      ...
      // You are required to write a function that returns all the Friends in a buddy list. Its signature should be:
      // function getBuddyListFriends(list: BuddyList): Friend[] {
      // [Hint: Use the array reduce method in the solution, where the objective is to reduce an array of Buddy objects to an array of Friend objects, i.e.
      // only some of the entries in the Buddy array are Friends.]

      function getBuddyListFriends(list: BuddyList): Friend[] {
         return list.members.reduce<Friend[]>((accumulator, currentValue) => {
